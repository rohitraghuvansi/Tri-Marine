...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmDefects))
        ...
        Me.Label1.Text = "Fish Rejects Information"
        '
        'cmdClose
        '
...
#End Region
    ...
    Private Sub frmDefects_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case cmd.Text
            ...
            Case "&Save"
                If Not cboDesc.Text.Trim = "" Then
                    If Not validateDefect(cboDesc.Text.Trim) Then
            ...
            Case "&Save "
                ...
                If reply = vbYes Then
                    updateDefect(lblCode.Text, cboDesc.Text)
                    cmd.Text = "&Add"
                    cmdEdit.Text = "&Edit"
                    buttons(1)
                    dataEntry(1)
    ...
    Public Sub saveNewRecord(ByVal defect As String)
        Try
            ...
            cmd.CommandText = "proc_addNew_Defect"
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        f.lblTitle.Text = "Search Type of Rejects"
        f.searchType = 1
        f.displayAllRejects()
        f.ShowDialog(Me)
