...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmProdPeriod))
        ...
        Me.Label1.Text = "Time Period Batch"
        '
        'grid
        '
        ...
        Me.Name = "frmProdPeriod"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "frmProdPeriod"
...
#End Region
    ...
    Private Sub frmProdPeriod_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub displayTPCode()
        With cboCode
            .DataSource = modModule.getProductPeriodCode().Tables(0)
            .Splits(0).DisplayColumns(0).Width = 130
        End With
    End Sub

    Public Sub displayTPDesc()
        With cboDesc
    ...
    Private Sub cmd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd.Click
        ...
        Select Case cmd.Text
            ...
            Case "&Save"
                If Not cboCode.Text.Trim = "" And Not cboDesc.Text.Trim = "" Then
                    If Not validateTP(cboCode.Text, cboDesc.Text) Then
                        ...
                        End If
                    Else
                        MsgBox("Time Period Batch already exists in the system. Please have another record.", MsgBoxStyle.Critical, "Result: Found duplicate record.")
                        cboDesc.SelectAll()
                        cboDesc.Focus()
                    End If
                Else
            ...
            Case "&Save "
                ...
                If reply = vbYes Then
                    updateTP(cboCode.Text, cboDesc.Text)
                    cmd.Text = "&Add"
                    cmdEdit.Text = "&Edit"
                    buttons(1)
                    dataEntry(1)
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        f.lblTitle.Text = "Search Time Period Batch"
        f.searchType = 1
        f.displayAllTP()
        f.ShowDialog(Me)
