...
Public Class rptInventory_Total
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMGPIS.rptInventory_Total.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventory_Total
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventory_Total = New rptInventory_Total()
        rpt.Site = Me.Site
        Return rpt
    End Function
