...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmProdCleaning))
        ...
        Me.Name = "frmProdCleaning"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "frmProdCleaning"
...
#End Region
    ...
    Private Sub frmProdCleaning_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub displayCSCode()
        With cboCode
            .DataSource = modModule.getProductCleaningCode().Tables(0)
            .Splits(0).DisplayColumns(0).Width = 130
        End With
    End Sub

    Public Sub displayCSDesc()
        With cboDesc
    ...
    Private Sub cmd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd.Click
        ...
        Select Case cmd.Text
            ...
            Case "&Save"
                If Not cboCode.Text.Trim = "" And Not cboDesc.Text.Trim = "" Then
                    If Not validateCS(cboCode.Text, cboDesc.Text) Then
                        ...
                        End If
                    Else
                        MsgBox("Cleaning style already exists in the system. Please have another record.", MsgBoxStyle.Critical, "Result: Found duplicate record.")
                        cboDesc.SelectAll()
                        cboDesc.Focus()
                    End If
                Else
            ...
            Case "&Save "
                ...
                If reply = vbYes Then
                    updateCS(cboCode.Text, cboDesc.Text)
                    cmd.Text = "&Add"
                    cmdEdit.Text = "&Edit"
                    buttons(1)
                    dataEntry(1)
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        f.lblTitle.Text = "Search Cleaning Style"
        f.searchType = 1
        f.displayAllCS()
        f.ShowDialog(Me)
