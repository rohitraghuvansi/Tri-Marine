...
Public Class rptPrintPalletTag
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMGPIS.rptPrintPalletTag.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintPalletTag
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintPalletTag = New rptPrintPalletTag()
        rpt.Site = Me.Site
        Return rpt
    End Function
