...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmProdPackStyle))
        ...
        Me.cboCode.Images.Add(CType(resources.GetObject("resource.Images2"), System.Drawing.Bitmap))
        ...
        Me.cboPackType.DataMode = C1.Win.C1List.DataModeEnum.AddItem
        ...
        Me.cboPackType.Images.Add(CType(resources.GetObject("resource.Images3"), System.Drawing.Bitmap))
        Me.cboPackType.ItemHeight = 20
        Me.cboPackType.Location = New System.Drawing.Point(88, 120)
        Me.cboPackType.MatchEntryTimeout = CType(2000, Long)
        Me.cboPackType.MaxDropDownItems = CType(20, Short)
        ...
        Me.cboPackType.Size = New System.Drawing.Size(152, 24)
        Me.cboPackType.TabIndex = 46
        ...
        Me.ControlBox = False
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Label4, Me.cboPackType, Me.Label3, Me.Label2, Me.Label5, Me.Label1, Me.grid, Me.cmdClose, Me.cmdPrint, Me.cmdFind, Me.cmdEdit, Me.cmd, Me.cboDesc, Me.cboCode})
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog
        Me.Name = "frmProdPackStyle"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "frmProdPackStyle"
...
#End Region
    ...
    Private Sub frmProdPackStyle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub displayPSCode()
        With cboCode
            .DataSource = modModule.getPackStyleCode().Tables(0)
            .Splits(0).DisplayColumns(0).Width = 130
        End With
    End Sub

    Public Sub displayPSDesc()
        With cboDesc
            .DataSource = modModule.getPackStyleDescription().Tables(0)
            .Splits(0).DisplayColumns(0).Width = 434
        End With
    End Sub

    Public Sub displayPackType()
        With cboPackType
            .ClearItems()
            .DefColWidth = 130
    ...
    Public Sub dataEntry(ByVal s As Int16)
        ...
        Select Case s
            Case 0
                ...
                cboPackType.ReadOnly = False
                grid.Enabled = True
            Case 1
                cboCode.ReadOnly = True
                cboDesc.ReadOnly = True
                cboPackType.ReadOnly = True
                grid.Enabled = False
        End Select
    End Sub
    ...
    Private Sub cmd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd.Click
        ...
        Select Case cmd.Text
            ...
            Case "&Save"
                If Not cboCode.Text.Trim = "" And Not cboDesc.Text.Trim = "" Then
                    If Not validatePS(cboCode.Text, cboDesc.Text) Then
                        ...
                        End If
                    Else
                        MsgBox("Pack style already exists in the system. Please have another record.", MsgBoxStyle.Critical, "Result: Found duplicate record.")
                        cboDesc.SelectAll()
                        cboDesc.Focus()
                    End If
                Else
            ...
            Case "&Save "
                ...
                If reply = vbYes Then
                    updatePS(cboCode.Text, cboDesc.Text, cboPackType.Text)
                    cmd.Text = "&Add"
                    cmdEdit.Text = "&Edit"
                    buttons(1)
                    dataEntry(1)
    ...
    Private Sub cboPackType_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboPackType.TextChanged
        If cboPackType.Text = "" Then If cboPackType.ListCount > 0 Then cboPackType.SelectedIndex = 0
    End Sub
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        f.lblTitle.Text = "Search Product Pack Style"
        f.searchType = 1
        f.displayAllPS()
        f.ShowDialog(Me)
