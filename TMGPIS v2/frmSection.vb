...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmSection))
        ...
        Me.cboDesc.Images.Add(CType(resources.GetObject("resource.Images"), System.Drawing.Bitmap))
        ...
        Me.Label1.Text = "Production Section"
        '
        'Label2
        '
        ...
        Me.ControlBox = False
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Label3, Me.Label2, Me.Label5, Me.lblCode, Me.Label1, Me.cmdClose, Me.cmdPrint, Me.cmdFind, Me.cmdEdit, Me.cmd, Me.grid, Me.cboDesc})
...
#End Region
    ...
    Private Sub cmd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd.Click
        ...
        Select Case cmd.Text
            ...
            Case "&Save"
                If Not cboDesc.Text.Trim = "" Then
                    If Not validateSection(cboDesc.Text.Trim) Then
                        ...
                        End If
                    Else
                        MsgBox("Production section already exists in the system. Please have another record.", MsgBoxStyle.Critical, "Result: Found duplicate record.")
                        cboDesc.SelectAll()
                        cboDesc.Focus()
                    End If
                Else
            ...
            Case "&Save "
                ...
                If reply = vbYes Then
                    updateSection(lblCode.Text, cboDesc.Text)
                    cmd.Text = "&Add"
                    cmdEdit.Text = "&Edit"
                    buttons(1)
                    dataEntry(1)
    ...
    Public Sub saveNewRecord(ByVal section As String)
        Try
            ...
            cmd.CommandText = "proc_addNew_Section"
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        f.lblTitle.Text = "Search Production Section"
        f.searchType = 1
        f.displayAllSection()
        f.ShowDialog(Me)
