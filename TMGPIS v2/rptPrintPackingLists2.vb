...
Public Class rptPrintPackingLists2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPrintPackingLists2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMGPIS.rptPrintPackingLists2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintPackingLists2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintPackingLists2 = New rptPrintPackingLists2()
        rpt.Site = Me.Site
        Return rpt
    End Function
