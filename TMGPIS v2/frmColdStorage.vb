...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmColdStorage))
        ...
        'cboRm
        '
        Me.cboRm.AddItemSeparator = Microsoft.VisualBasic.ChrW(59)
        ...
        Me.cboRm.Images.Add(CType(resources.GetObject("resource"), System.Drawing.Image))
        Me.cboRm.ItemHeight = 20
        Me.cboRm.Location = New System.Drawing.Point(136, 87)
        ...
        Me.cboRm.Size = New System.Drawing.Size(376, 24)
        Me.cboRm.TabIndex = 2
        Me.cboRm.PropBag = "<?xml version=""1.0""?><Blob><Styles type=""C1.Win.C1List.Design.ContextWrapper""><Da" & _
        ...
        Me.txtLane.Location = New System.Drawing.Point(136, 119)
        Me.txtLane.Name = "txtLane"
        Me.txtLane.Size = New System.Drawing.Size(136, 23)
        Me.txtLane.TabIndex = 3
        Me.txtLane.Text = "0"
        Me.txtLane.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        '
        'txtRow
        '
        Me.txtRow.Font = New System.Drawing.Font("Tahoma", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.txtRow.Location = New System.Drawing.Point(136, 151)
        Me.txtRow.Name = "txtRow"
        Me.txtRow.Size = New System.Drawing.Size(136, 23)
        ...
        Me.cmdClose.Location = New System.Drawing.Point(384, 416)
        ...
        Me.cmdPrint.Location = New System.Drawing.Point(304, 416)
        ...
        Me.cmdFind.Location = New System.Drawing.Point(224, 416)
        ...
        Me.cmdEdit.Location = New System.Drawing.Point(144, 416)
        ...
        Me.cmd.Location = New System.Drawing.Point(64, 416)
        Me.cmd.Name = "cmd"
        ...
        Me.Label3.Text = "Cold Storage Room *"
        '
        'Label5
        '
        ...
        Me.Label5.Text = "Cold Storage Code"
        '
        'Label1
        '
        ...
        Me.Label1.Size = New System.Drawing.Size(522, 40)
        Me.Label1.TabIndex = 27
        Me.Label1.Text = "Cold Storage Information"
        '
        'lblCode
        '
        ...
        Me.lblCode.Location = New System.Drawing.Point(136, 53)
        Me.lblCode.Name = "lblCode"
        Me.lblCode.Size = New System.Drawing.Size(136, 24)
        ...
        Me.grid.Location = New System.Drawing.Point(9, 192)
        Me.grid.Name = "grid"
        Me.grid.PreviewInfo.Location = New System.Drawing.Point(0, 0)
        Me.grid.PreviewInfo.Size = New System.Drawing.Size(0, 0)
        Me.grid.PreviewInfo.ZoomFactor = 75
        Me.grid.RowHeight = 20
        Me.grid.Size = New System.Drawing.Size(504, 216)
        Me.grid.TabIndex = 33
        ...
        "elWidth=""17"" VerticalScrollGroup=""1"" HorizontalScrollGroup=""1""><Height>212</Heig" & _
        ...
        "yle6"" /><Style parent=""Normal"" me=""Style1"" /><ClientRect>0, 0, 500, 212</ClientR" & _
        ...
        "lWidth>17</DefaultRecSelWidth><ClientArea>0, 0, 500, 212</ClientArea><PrintPageH" & _
        ...
        Me.ClientSize = New System.Drawing.Size(522, 470)
        Me.ControlBox = False
        ...
        Me.Name = "frmColdStorage"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "frmColdStorage"
...
#End Region
    ...
    Private Sub frmColdStorage_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtLane_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtLane.TextChanged
        If Not IsNumeric(txtLane.Text) Or txtLane.Text.Trim = "" Then
            txtLane.Text = "0"
            txtLane.SelectAll()
            txtLane.Focus()
        End If

        'If CDbl(txtLane.Text) < 0 Then txtLane.Text = "0"
    End Sub

    Private Sub txtRow_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtRow.TextChanged
        If Not IsNumeric(txtRow.Text) Or txtRow.Text.Trim = "" Then
            txtRow.Text = "0"
            txtRow.SelectAll()
            txtRow.Focus()
        End If

        'If CDbl(txtRow.Text) < 0 Then txtRow.Text = "0"
    End Sub
    ...
    Public Sub dataEntry(ByVal s As Int16)
        ...
        Select Case s
            Case 0
                cboRm.ReadOnly = False
                txtLane.ReadOnly = False
                txtRow.ReadOnly = False
            Case 1
                cboRm.ReadOnly = True
                txtLane.ReadOnly = True
    ...
    Private Sub cmd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd.Click
        ...
        Select Case cmd.Text
            Case "&Add"
                ...
                cboRm.Focus()
            Case "&Save"
                If Not cboRm.Text.Trim = "" Or Not txtLane.Text.Trim = "" Or _
                Not txtLane.Text.Trim = "0" Or Not txtRow.Text.Trim = "" Or Not txtRow.Text.Trim = "0" Then
                    If Not validateColdStorage(cboRm.Text.Trim) Then
                        reply = MsgBox("Are you sure you want to add this new record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmation")
                        If reply = vbYes Then
                            saveNewColdStorage(cboRm.Text, txtLane.Text, txtRow.Text)

                            Dim l As Integer = 1
                            Dim r As Integer
                            While l <= txtLane.Text
                                r = 1
                                While r <= txtRow.Text
                                    saveNewColdStorageLayout(lblCode.Text, l, r, "0")
                                    r += 1
                                End While
                        ...
                        End If
                    Else
                        MsgBox("Cold Storage room already exists in the system. Please have another record.", MsgBoxStyle.Critical, "Result: Found duplicate record.")
                        cboRm.SelectAll()
                        cboRm.Focus()
                    End If
                Else
            ...
            Case "&Save "
                ...
                If reply = vbYes Then
                    updateColdStorage(lblCode.Text, cboRm.Text, txtLane.Text, txtRow.Text)

                    deleteColdStorageLayout(lblCode.Text)
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        f.lblTitle.Text = "Search Cold Storage"
        f.searchType = 1
        f.displayAllColdStorage()
        f.ShowDialog(Me)

        With f.grid
            If Not f.cancel Then
                lblCode.Text = .Item(.Row, 3)
                cboRm.Text = .Item(.Row, 0)
                txtLane.Text = .Item(.Row, 1)
                txtRow.Text = .Item(.Row, 2)
            End If
        End With
    End Sub

    Public Sub saveNewColdStorage(ByVal rm As String, ByVal lane As String, ByVal row As String)
        Try
            ...
            cmd.CommandText = "proc_addNew_ColdStorage"
            ...
            p1.Value = Format(getColdStorageCounter(), "CS0##")
            lblCode.Text = p1.Value

            Dim p2 As New SqlClient.SqlParameter
            p2.ParameterName = "@csName"
