...
Public Class rptPrintRRDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMGPIS.rptPrintRRDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintRRDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintRRDetails = New rptPrintRRDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
