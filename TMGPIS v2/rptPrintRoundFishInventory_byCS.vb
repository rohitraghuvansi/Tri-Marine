...
Public Class rptPrintRoundFishInventory_byCS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPrintRoundFishInventory_byCS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMGPIS.rptPrintRoundFishInventory_byCS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintRoundFishInventory_byCS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintRoundFishInventory_byCS = New rptPrintRoundFishInventory_byCS()
        rpt.Site = Me.Site
        Return rpt
    End Function
