...
Public Class rptPrintFWR_Lot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMGPIS.rptPrintFWR_Lot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintFWR_Lot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintFWR_Lot = New rptPrintFWR_Lot()
        rpt.Site = Me.Site
        Return rpt
    End Function
